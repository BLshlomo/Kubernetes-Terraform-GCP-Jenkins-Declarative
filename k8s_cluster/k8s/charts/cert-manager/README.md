...
# Kubernetes <1.15
$ kubectl apply --validate=false -f https://github.com/jetstack/cert-manager/releases/download/v1.0.0-alpha.1/cert-manager-legacy.crds.yaml
```
...
```console
# Kubernetes 1.15+
$ kubectl delete -f https://github.com/jetstack/cert-manager/releases/download/v1.0.0-alpha.1/cert-manager.crds.yaml

# Kubernetes <1.15
$ kubectl delete -f https://github.com/jetstack/cert-manager/releases/download/v1.0.0-alpha.1/cert-manager-legacy.crds.yaml
```
...
| `image.tag` | Image tag | `v1.0.0-alpha.1` |
...
| `webhook.image.tag` | Webhook image tag | `v1.0.0-alpha.1` |
...
| `cainjector.image.tag` | cainjector image tag | `v1.0.0-alpha.1` |
